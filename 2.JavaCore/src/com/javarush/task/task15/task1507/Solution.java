...
//    }
    ...
    public static void printMatrix(byte m, Object n, Object value) {
        System.out.println("Заполняем объектами String");
        printMatrix(m, n, value);
    }
    public static void printMatrix(Object m, byte n, Object value) {
        System.out.println("Заполняем объектами String");
        printMatrix(m, n, value);
    }
    ...
    public static void printMatrix(short m, Object n, Object value) {
        System.out.println("Заполняем объектами String");
        printMatrix(m, n, value);
    }
    public static void printMatrix(Object m, short n, Object value) {
        System.out.println("Заполняем объектами String");
        printMatrix(m, n, value);
    }
